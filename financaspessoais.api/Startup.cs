...
namespace financaspessoais.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGetLancamento,GetLancamento>();
            services.AddTransient<ICreateLancamento,CreateLancamento>();
            services.AddTransient<ILancamentoRepository,LancamentoSqlRepository>();
